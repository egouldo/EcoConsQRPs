...
typology_tbl <- typology %>%
        ...
        gt::tab_style(style = cell_text(v_align = "top"),
                      locations = cells_body(columns = everything(), 
                                             rows = c(3,6)))
gt::gtsave(typology_tbl, path = here::here("tables/"), filename = "QRP_typology.pdf")
```
...
typology_tbl
#magick::image_read_pdf(here::here("tables", "QRP_typology.pdf"))
